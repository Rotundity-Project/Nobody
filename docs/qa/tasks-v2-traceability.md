...
| 25. 发布准备 | 未完成 | 部分完成（增强中） | 已补发布草案、迁移兼容策略与 changelog 草案（`docs/release/v2-release-prep.md`, `docs/release/migration-v2.md`, `docs/release/v2-changelog-draft.md`），待补最终版本号与灰度结果 |
